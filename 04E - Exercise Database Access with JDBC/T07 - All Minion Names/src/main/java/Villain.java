...
public class Villain {
    ...
    public Villain(int id, Connection connection) throws SQLException {
        ...
        minions = getMinionsFromDB(id, connection);
    ...
    public static int removeVillain(int id, Connection connection) throws SQLException {
        ...
        releasedMinions = releaseMinionsStatement.executeUpdate();

        PreparedStatement deleteVillainStatement = connection.prepareStatement(
                "DELETE FROM villains WHERE id = ?");
        deleteVillainStatement.setInt(1, id);

        if(1 != deleteVillainStatement.executeUpdate()) {
            connection.rollback();
...
//                throw new SQLException("Unable to create villain " + name + " into DB");
    ...
    private static List<Minion> getMinionsFromDB(int id, Connection connection) throws SQLException {
